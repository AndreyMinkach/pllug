...
char moveAndGather(int row,
                   ...
                   std::array<std::array<char, cMazeColumns>, cMazeRows> &prMaze, bool isKeyFound)
{
...
bool moveCharacterAndCheckIfExitFound(std::array<std::array<char, cMazeColumns>, cMazeRows> &prMaze, bool &rKeyFound)
{
